...
public class RedMTI21ArtifactAuto extends CommandOpMode {
    ...
    private final Pose startPose = new Pose(112.586, 136.163, H0);
    private final Pose pose1 = new Pose(87.922, 74.862, Math.toRadians(67));
    private final Pose nearMark = new Pose(127.128, 83.66);
    private final Pose nearShoot = new Pose(94.608, 83.138);
    private final Pose nearShootCP = new Pose(97.35, 66.32);
    private final Pose collectMiddleMarkCP = new Pose(96.025, 59.109);
    private final Pose collectMiddleMark = new Pose(126, 58.945);
    ...
    private final Pose collectRamp = new Pose(135.5, 61, Math.toRadians(26));
    ...
    private PathChain path1, path2, path3, path4, path5, path6, path7, path8, path9, path10, path10Mid, path10End, path11, path12, path13, path12Mid, path12End, humanPlayerCollectPath, humanPlayerToShoot, humanPlayerCollectPathFinish;
...
//                new WaitCommand(200),
                ...
                new setTurretPos(turret, path7.endPose()),
                new FollowPathCommand(follower, path7),
//                new WaitCommand(200),
                shooterSequence,
                new FollowPathCommand(follower, path8, true),
                new setTurretPos(turret, path9.endPose()),
                new WaitCommand(1000),
                new FollowPathCommand(follower, path9),
//                new WaitCommand(200),
...
//                shooterSequence,
                ...
                new setTurretPos(turret, path11.endPose()),
